...
const InstallButton = () => {
    ...
    return (
        <button onClick={handleInstallClick} className="bg-white group text-orange-500 hover:text-white shadow-inner hover:shadow-lg shadow-black/30 hover:shdow-white/30 hover:bg-blue-500 rounded-md p-1.5" style={{ display: deferredPrompt ? "block" : "none" }}>
